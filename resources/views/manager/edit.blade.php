<x-guest-layout>
    ...
    <form method="POST" enctype="multipart/form-data" action="{{ url("/manager/") }}">
        @csrf
        ...
        <div>
            ...
            <x-text-input id="book_name" class="block mt-1 w-full" type="book_name" name="book_name" :value="old('book_name')" required
                autofocus autocomplete="username" value=/>
        ...
        <div class="mt-4">
            ...
            <x-file-input id="picture" class="block mt-1 w-full" type="picture" required
